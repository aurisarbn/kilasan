<?php $__env->startSection('title', 'Form Pengaduan'); ?>
...
<section class="container py-5">
    ...
    <div class="card p-4">
        <form method="post" action="<?php echo e(route('reports.store')); ?>" enctype="multipart/form-data" id="report-form">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="wilayah" id="wilayah_combined" value="<?php echo e(old('wilayah')); ?>">
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control" name="nama" value="<?php echo e(old('nama')); ?>" placeholder="Boleh anonim">
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-bold">Kontak WA/Telepon *</label>
                    <input class="form-control" name="kontak" value="<?php echo e(old('kontak')); ?>" required placeholder="08xxxxxxxxxx">
                </div>
                <div class="col-md-6">
            ...
            <div class="row g-3 mt-2">
                ...
                <div class="col-12"><label class="form-label fw-bold">Kronologi Singkat</label><textarea class="form-control" name="kronologi" rows="4"><?php echo e(old('kronologi')); ?></textarea></div>
                <div class="col-12"><label class="form-label fw-bold">Saran / Masukan</label><textarea class="form-control" name="saran" rows="2"><?php echo e(old('saran')); ?></textarea></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pengmas\KILASAN\resources\views/reports/create.blade.php ENDPATH**/ ?>